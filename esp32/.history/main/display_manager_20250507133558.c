...
esp_err_t display_manager_init(void)
{
    ...
    lv_obj_set_style_text_color(label_title, 0x0000, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(label_status, &cjk_22, 0);
