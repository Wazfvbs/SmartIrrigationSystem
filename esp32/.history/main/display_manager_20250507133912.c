...
esp_err_t display_manager_init(void)
{
    ...
    lv_obj_set_style_text_font(label_title, &gb2312_22, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(label_info, &gb2312_22, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(label_status, &gb2312_22, LV_PART_MAIN);
