...
/*====================
 * 启用 Unifont 支持中文 + Emoji
 *===================*/
#define LV_FONT_UNIFONT 1
#define LV_FONT_UNIFONT_LOAD_CJK 1       /* 加载 CJK 字符集 */
#define LV_FONT_UNIFONT_EXTENDED_EMOJI 1 /* 加载常见 Emoji */
...
#define LV_FONT_DEFAULT &lv_font_unifont
 ...
 *小部件
 *================*/
/*小部件的文档可以在此处找到：https：//docs.lvgl.io/master/details/widgets/index.html。 */
 ...
 *主题
 *=================*/
/*主题文档可以在此处找到：https：//docs.lvgl.io/master/details/common-widget-features/styles/style.html#themes。 */
 ...
 *布局
 *=================*/
/*布局文档可以在此处找到：https：//docs.lvgl.io/master/details/common-widget-features/layouts/index.html。 */
